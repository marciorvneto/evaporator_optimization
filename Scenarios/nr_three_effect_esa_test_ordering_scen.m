...
engine.QBounds = [1000,1000];
engine.ABounds = [1000,1000];
engine.temperatureBounds = [373,473];
engine.pressureBounds = [100,200];
...
var = engine.solveEasy((lb+ub)/2);

res=feasy(var);

engine.returnVariables(engine.handler,var)
